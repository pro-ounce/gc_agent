...
ROUTES: dict[str, str] = {
    ...
    "my_fund_groups": "the CALLER's own fund groups in the current app: 'my fund groups', 'fund groups assigned to me'",
    "user_fund_groups": "a NAMED OTHER user's fund groups: 'fund groups for <user>', \"<user>'s fund groups\"",
    "fund_groups": "list ALL fund groups in the system (the catalogue)",
